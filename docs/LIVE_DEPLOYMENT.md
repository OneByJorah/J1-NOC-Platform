...
1. Edit code in `/home/<user>/J1-NOC-Platform` as normal.
2. Commit and push to GitHub.
3. Run the deploy script as root:
   ```bash
   sudo /home/<user>/J1-NOC-Platform/scripts/deploy.sh
   ```
The script:
- Pulls latest code
...
```bash
sudo cp /home/<user>/J1-NOC-Platform/systemd/j1-noc-platform.service /etc/systemd/system/
...
```bash
cp /home/<user>/J1-NOC-Platform/.githooks/pre-commit /home/<user>/J1-NOC-Platform/.git/hooks/pre-commit
chmod +x /home/<user>/J1-NOC-Platform/.git/hooks/pre-commit
```
