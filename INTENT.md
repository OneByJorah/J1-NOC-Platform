...
- **Windows Agent default NOC URL**: The agent defaults to `http://100.72.207.60` — a Tailscale IP that was later redacted from the README but remains in the agent source code.
